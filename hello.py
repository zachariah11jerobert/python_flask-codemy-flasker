...
] = "mysql+pymysql://root:manager@localhost/codemy_users"
# Secret Key!
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return render_template(
                "update_user.html", form=form, name_to_update=name_to_update
            )
        except:
...
def delete(id):
    ...
    try:
        ...
        flash("Whoops!!! There was a problem deleting User , ... plz try gain")
        our_users = Users.query.order_by(Users.date_added)
        return render_template("add_user.html", form=form, name=name, our_users=our_users)
